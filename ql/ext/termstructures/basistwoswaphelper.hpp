...
public:
    BasisTwoSwapHelper(const Handle<Quote>& spread, const Period& swapTenor, const Calendar& calendar,
                       ...
                       const DayCounter& longFixedDayCount, const ext::shared_ptr<IborIndex>& longIndex,
                       // Short tenor swap
                       Frequency shortFixedFrequency, BusinessDayConvention shortFixedConvention,
                       const DayCounter& shortFixedDayCount, const ext::shared_ptr<IborIndex>& shortIndex,
    ...
    //@{
    ext::shared_ptr<VanillaSwap> longSwap() const;
    ext::shared_ptr<VanillaSwap> shortSwap() const;
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    ext::shared_ptr<VanillaSwap> longSwap_;
    ext::shared_ptr<VanillaSwap> shortSwap_;
...
inline ext::shared_ptr<VanillaSwap> BasisTwoSwapHelper::shortSwap() const { return shortSwap_; }

inline ext::shared_ptr<VanillaSwap> BasisTwoSwapHelper::longSwap() const { return longSwap_; }
}
