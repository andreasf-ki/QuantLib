...
public:
    ...
    */
    ...
    const ext::shared_ptr<IborIndex>& foreignIndex() const { return foreignIndex_; }
    ...
    const ext::shared_ptr<IborIndex>& domesticIndex() const { return domesticIndex_; }
...
private:
    ...
    ext::shared_ptr<IborIndex> foreignIndex_;
    Spread foreignSpread_;

    Currency domesticCurrency_;
    Schedule domesticSchedule_;
    ext::shared_ptr<IborIndex> domesticIndex_;
