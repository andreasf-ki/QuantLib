...
class FXLinked {
public:
    FXLinked(const Date& fixingDate, Real foreignAmount, ext::shared_ptr<FxIndex> fxIndex, bool invertIndex = false);
...
public:
    FXLinkedCashFlow(const Date& cashFlowDate, const Date& fixingDate, Real foreignAmount,
                     ext::shared_ptr<FxIndex> fxIndex, bool invertIndex = false);
