...
public:
    CrossCcyBasisSwapHelper(const Handle<Quote>& spreadQuote, const Handle<Quote>& spotFX, Natural settlementDays,
                            ...
                            const ext::shared_ptr<QuantLib::IborIndex>& flatIndex,
                            const ext::shared_ptr<QuantLib::IborIndex>& spreadIndex,
    ...
    //! \name inspectors
    //@{
    ext::shared_ptr<CrossCcyBasisSwap> swap() const { return swap_; }
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    ext::shared_ptr<QuantLib::IborIndex> flatIndex_;
    ext::shared_ptr<QuantLib::IborIndex> spreadIndex_;
    ...
    ext::shared_ptr<CrossCcyBasisSwap> swap_;
