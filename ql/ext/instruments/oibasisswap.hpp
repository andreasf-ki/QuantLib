...
public:
    ...
    OvernightIndexedBasisSwap(Type type, Real nominal, const Schedule& oisSchedule,
                              const ext::shared_ptr<OvernightIndex>& overnightIndex, const Schedule& iborSchedule,
                              const ext::shared_ptr<IborIndex>& iborIndex, Spread oisSpread = 0.0,
    ...
    const ext::shared_ptr<IborIndex>& iborIndex() { return iborIndex_; };
