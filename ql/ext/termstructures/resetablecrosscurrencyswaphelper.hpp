...
public:
    ...
    //! \name inspectors
    //@{
    ext::shared_ptr<ResetableCrossCurrencySwap> swap() const { return swap_; }
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    ext::shared_ptr<QuantLib::IborIndex> foreignCcyIndex_;
    ext::shared_ptr<QuantLib::IborIndex> domesticCcyIndex_;
    ...
    ext::shared_ptr<ResetableCrossCurrencySwap> swap_;
