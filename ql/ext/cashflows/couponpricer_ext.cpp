...
private:
    const ext::shared_ptr<FloatingRateCouponPricer> pricer_;

public:
    PricerSetter(const ext::shared_ptr<FloatingRateCouponPricer>& pricer) : pricer_(pricer) {}
...
void PricerSetter::visit(AverageONIndexedCoupon& c) {
    const ext::shared_ptr<AverageONIndexedCouponPricer> averageONIndexedCouponPricer =
        ext::dynamic_pointer_cast<AverageONIndexedCouponPricer>(pricer_);
...
void PricerSetter::visit(SubPeriodsCoupon_ext& c) {
    const ext::shared_ptr<SubPeriodsCouponPricer> subPeriodsCouponPricer =
        ext::dynamic_pointer_cast<SubPeriodsCouponPricer>(pricer_);
    QL_REQUIRE(subPeriodsCouponPricer, "Pricer not compatible with sub-periods coupon");
    c.setPricer(subPeriodsCouponPricer);
}
}

void setCouponPricer_ext(const Leg& leg, const ext::shared_ptr<FloatingRateCouponPricer>& pricer) {
...
void setCouponPricers_ext(const Leg& leg, const std::vector<ext::shared_ptr<FloatingRateCouponPricer> >& pricers) {
