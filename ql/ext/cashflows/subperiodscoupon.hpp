...
public:
    ...
    SubPeriodsCoupon_ext(const Date& paymentDate, Real nominal, const Date& startDate, const Date& endDate,
                     const ext::shared_ptr<InterestRateIndex>& index, Type type, BusinessDayConvention convention,
...
class SubPeriodsLeg {
public:
    SubPeriodsLeg(const Schedule& schedule, const ext::shared_ptr<InterestRateIndex>& index);
