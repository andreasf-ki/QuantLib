...
public:
    OICCBSHelper(Natural settlementDays,
                 ...
                 const ext::shared_ptr<OvernightIndex>& payIndex, const Period& payTenor,
                 const ext::shared_ptr<OvernightIndex>& recIndex, const Period& recTenor,
    ...
    //! \name inspectors
    //@{
    ext::shared_ptr<OvernightIndexedCrossCcyBasisSwap> swap() const { return swap_; }
    //@}
    //! \name Visitability
    //@{
...
protected:
    ...
    Period term_;
    ext::shared_ptr<OvernightIndex> payIndex_;
    Period payTenor_;
    ext::shared_ptr<OvernightIndex> recIndex_;
    Period recTenor_;
    Handle<YieldTermStructure> fixedDiscountCurve_;
    bool spreadQuoteOnPayLeg_;
    bool fixedDiscountOnPayLeg_;

    ext::shared_ptr<OvernightIndexedCrossCcyBasisSwap> swap_;
